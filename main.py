...
cap1 = cv2.VideoCapture('videoplayback.mp4')
cap2 = cv2.VideoCapture('animal.mp4')

last_frame = None
sensibilidade =  6000  #quanto menor mais sensivel (detecta movimento menores)
